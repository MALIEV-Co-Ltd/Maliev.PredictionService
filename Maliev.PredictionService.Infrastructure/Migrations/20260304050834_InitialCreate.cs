    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("p_k_prediction_audit_logs", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("p_k_training_jobs", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("p_k_ml_models", x => x.id);
                    table.ForeignKey(
                        name: "f_k_ml_models_training_jobs_training_job_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("p_k_training_datasets", x => x.id);
                    table.ForeignKey(
                        name: "f_k_training_datasets_training_jobs_training_job_id",
                        column: x => x.training_job_id,
                        principalSchema: "training",
                        principalTable: "training_jobs",
                        principalColumn: "id",
            ...
            migrationBuilder.CreateIndex(
                name: "i_x_ml_models_training_job_id",
                schema: "ml_models",
                table: "ml_models",
            ...
            migrationBuilder.CreateIndex(
                name: "i_x_training_datasets_training_job_id",
                schema: "training",
                table: "training_datasets",
                column: "training_job_id",
                unique: true);
